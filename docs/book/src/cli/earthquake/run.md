...
Options:
  ...
  -a, --max-vwap-post <MAX_VWAP_POST>
      ...
      --weights-pre-vwap <PRE_DECAY_WEIGHT_VWAP>
          Rate of decay of bi-exponential decay function see calculate_weight in earthquake_types::db::cex

          [default: -0.0000005]

      --weights-post-vwap <POST_DECAY_WEIGHT_VWAP>
          Rate of decay of bi-exponential decay function see calculate_weight in earthquake_types::db::ce
