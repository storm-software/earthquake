...
let __wasmFilePath = __nodePath.join(__dirname, 'earthquake-binding.wasm32-wasi.wasm')
const __wasmDebugFilePath = __nodePath.join(__dirname, 'earthquake-binding.wasm32-wasi.debug.wasm')

if (__nodeFs.existsSync(__wasmDebugFilePath)) {
  __wasmFilePath = __wasmDebugFilePath
} else if (!__nodeFs.existsSync(__wasmFilePath)) {
  try {
    __wasmFilePath = require.resolve('@earthquake/binding-wasm32-wasi/earthquake-binding.wasm32-wasi.wasm')
  } catch {
    throw new Error('Cannot find earthquake-binding.wasm32-wasi.wasm file, and @earthquake/binding-wasm32-wasi package is not installed.')
  }
}
...
module.exports.BindingStaticAnalysisEngine = __napiModule.exports.BindingStaticAnalysisEngine
