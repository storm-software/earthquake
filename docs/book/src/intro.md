...
<div style="text-align: center;">
    <img src="https://public.storm-cdn.com/storm-banner.gif" alt="Storm Software" style="width: 100%; height: auto;">
</div>
...
**Earthquake** is built using <a href="https://nx.dev/" target="_blank">Nx</a>,
...
- **Running Earthquake**: Follow our
  [quick-start instructions](./run/run_earthquake.md)
- **Under the Hood**: Explore Earthquake'
  [architecture](./architecture/intro.md)
- **CLI Reference**: Learn about Earthquake's
