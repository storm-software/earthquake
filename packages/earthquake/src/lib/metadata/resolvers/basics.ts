...
import { resolveAbsoluteUrlWithPathname } from "./url";
...
export const resolveThemeColor: FieldResolver<
  "themeColor",
  Viewport
> = themeColor => {
...
export const resolveVerification: FieldResolver<
  "verification"
> = verification => {
