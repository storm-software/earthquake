...
const __wasmDebugFilePath = __nodePath.join(
  __dirname,
  "earthquake-binding.wasm32-wasi.debug.wasm"
);
...
if (__nodeFs.existsSync(__wasmDebugFilePath)) {
  ...
  try {
    __wasmFilePath =
      require.resolve("@earthquake/binding-wasm32-wasi/earthquake-binding.wasm32-wasi.wasm");
  } catch {
    throw new Error(
      "Cannot find earthquake-binding.wasm32-wasi.wasm file, and @earthquake/binding-wasm32-wasi package is not installed."
    );
  }
}
